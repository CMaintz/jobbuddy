...
- **Cross-listing dedup** — a 64-bit **SimHash** content fingerprint (`SimHash`, from career-ops)
...
from the fit score** (`RiskAssessment`, framing from career-ops):
...
At PDF render time (`PdfRenderingService`, techniques from career-ops):
